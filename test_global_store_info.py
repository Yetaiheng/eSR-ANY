#测试重参数化后的全局测试的代码，也可以测试未重参数化的,并存储部分信息
from re import L
import torch
...
from models.ecbsr_5_re import ECBSR_5_one_re,ECBSR_5_one_re_store
...
if __name__ == '__main__':
    ...
    model = ECBSR_5_one_re_store().to(device)
    print(model)
    #device_ids = [0,1]
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.test_every == 0:
            ...
            for valid_dataloader in valid_dataloaders:
                ...
                #np.savetxt('output2/result.txt',psnr_log)
